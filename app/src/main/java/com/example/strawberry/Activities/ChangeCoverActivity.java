...
import com.example.strawberry.databinding.ActivityChangeCoverBinding;
...
public class ChangeCoverActivity extends AppCompatActivity {
    ActivityChangeCoverBinding binding;
    Uri imageUri = null;
    Integer n = 0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityChangeCoverBinding.inflate(getLayoutInflater());
        ...
        binding.post.setOnClickListener(v -> {
            if (imageUri == null) {
                ...
                Post post = new Post();
                Date date = new Date();
                post.setContent("Cập nhật ảnh bìa");
                post.setComment(0);
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onSuccess(Uri uri) {
                                            databaseReference.child("users/idUser" + user.getIdUser() + "/linkCover").setValue(uri.toString());
                                            ...
                                            finish();
                                            Constants.showToast("Cập nhật ảnh bìa thành công!", getApplicationContext());
                                        }
                                    });
                                }

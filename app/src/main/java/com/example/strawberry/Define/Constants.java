...
public class Constants {
    public static final String ENTER_USER_NAME = "Email hoặc số điện thoại trống";
    public static final String ENTER_PASSWORD = "Mật khẩu trống";
    public static final String ERROR_LOGIN = "Tài khoản không tồn tại";
    public static final String ERROR_SIGN_UP = "Tên email hoặc số điện thoại đã tồn tại";
